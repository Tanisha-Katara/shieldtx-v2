...
`dist/assets/terminal-preview.jpg` is the complete frame at **00:02** from ShieldTX's [official product recording](https://www.shieldtx.xyz/assets/demo/preview.mp4). Extracted with FFmpeg; 1144 × 720 pixels; no crop, retouching, or invented interface elements.
