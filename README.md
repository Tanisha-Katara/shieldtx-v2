...
- **Continuous brand story:** the official ShieldTX bars assemble in sequence and become a framed shield with the bars retained inside. Only the symbol travels; the wordmark stays in the navigation and footer. One native-scroll timeline carries the symbol from the institution through the comparison, execution stages, terminal/API, questions and footer. Reduced motion shows the complete shield; a canvas fallback works without WebGL.
